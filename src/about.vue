                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" >
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/src/photo/content1.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/src/photo/content2.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="/src/photo/content3.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12" >
                <div class="text-container">
                    <div>
                        <img class="hb" src="/src/photo/banner1.jpg"/>
                    </div>
                    <div>
                        <img class="icon-fork" src="/src/photo/fork.png"/>
                    </div>
        ...
        <div class="row">
            <div class="col-12" >
                <div class="text-container2 ">
                    <div>
                        <img class="hb2" src="/src/photo/banner2.jpg"/>
                    </div>
                    <div>
                        <img class="icon-knife" src="/src/photo/french-knife.png"/>
                    </div>
...
.icon-bg{
    ...
    background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url('/src/photo/—Pngtree—close up of striped timber_15272361.jpg'); /* 原图片 */
    z-index: 0;
}
